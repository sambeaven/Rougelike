...
namespace Rougelike.GameLogic
{
    public class RLLevelGenerator
    {
        ...
        public List<RLAgent> GenerateAgents(agentGeneratorBehaviour generatorBehaviour)
        {
            if (generatorBehaviour == agentGeneratorBehaviour.ExcludeHero)
            {
                throw new NotImplementedException();
            }
            else
            {
                var agents = new List<RLAgent>();
